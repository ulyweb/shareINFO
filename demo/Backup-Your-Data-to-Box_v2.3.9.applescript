-- ============================================================================
--  BACKUP-TO-BOX  v2.3.9   "Backup Your Data to Box"
...
on run
        ...
        set mode1 to "① Standard Corporate Backup — ZIP  (Legal Hold: Desktop + Documents + Downloads + Movies + Music + Pictures + Bookmarks → Box)"
        ...
        set mode6 to "⑥ Custom Backup + Default Folders — ZIP  (Desktop + Documents + Downloads + Movies + Music + Pictures + Bookmarks → you pick where to save: Box / Network / OneDrive / external)"
