-- ============================================================================
--  BACKUP-TO-BOX  v2.3.10   "Mac Backup & Recovery Toolkit"
...
on run
        ...
        display dialog "🔐  PERMISSIONS CHECK" & return &  & return & "Grant these under  System Settings ▸ Privacy & Security:" & return &  & return & "•  Full Disk Access   —   REQUIRED (folders + Safari/Chrome bookmarks)" & return & "•  Files & Folders" & return & "•  Accessibility" & return &  & return & "⚠️  Add THIS app — “" & appTitle & "” — to Full Disk Access. Access you granted to Script Editor does NOT carry over to the exported app." & return &  & return & "Click OK when you're ready to continue." buttons {"OK"} default button "OK" with title appTitle with icon note
